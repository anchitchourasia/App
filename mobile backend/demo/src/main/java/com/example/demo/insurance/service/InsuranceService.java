...
public class InsuranceService {
  ...
  public void uploadPdf(long id, MultipartFile file, String uploadedBy) throws IOException {  // ✅ FIX: clean import
    ...
    // ✅ FIX: store once to avoid double-call NPE (SonarQube S2259)
